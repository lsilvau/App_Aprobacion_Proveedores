sap.ui.define([
	...
	"intsolicituddepedido/intSolicitudDePedido/model/formatter",
	"intsolicituddepedido/intSolicitudDePedido/model/models",
	"intsolicituddepedido/intSolicitudDePedido/model/config"
	...
	return Controller.extend("intsolicituddepedido.intSolicitudDePedido.controller.Principal", {
		...
		fnLoadAllData: function () {
			...
			urlGlobal = urlGlobal + "&ID=02&LIB=SP&USER=" + localStorage.getItem("sUser");
...
*/
		...
		onInfoUser: function (oEvent) {
			...
			if (!this._actionSheet) {
				this._actionSheet = sap.ui.xmlfragment("intsolicituddepedido.intSolicitudDePedido.fragment.FrgUserInformacion", this);
